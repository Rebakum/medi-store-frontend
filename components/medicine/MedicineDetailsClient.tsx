...
export default function MedicineDetailsClient({ id }: MedicineDetailsClientProps) {
  const { add } = useCart();
            ...
            <div className="p-6 border bg-white/80 dark:bg-white/5 border-slate-200 dark:border-white/10 rounded-2xl">
              ...
              <div className="grid grid-cols-1 gap-3 mt-5 sm:grid-cols-2">
                <button
                  disabled={!canBuy}
                  onClick={gotoCart}
                  className="w-full py-3 text-sm font-medium border-[#2EB0D9] border rounded-xl dark:border-white/10 dark:bg-white/5 hover:bg-slate-50 dark:hover:bg-white/10 text-slate-800 dark:text-slate-100 hover:text-[#2EB0D9] disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  Add to Cart
                </button>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-xl px-3 py-2 text-sm font-semibold text-white bg-[#2EB0D9] hover:bg-[#38CAE4] transition shadow-sm"
                >
                  Order Now
                </button>
              </div>
